...
def set_ap_client_mode():
   # hostname = "SUN_NODE" + "_" + subprocess.check_output(['cat', '/proc/cpuinfo'])[-5:-1].decode('utf-8')
   # os.system('touch /opt/sun/test.txt')
   # command = ('echo ', hostname, ' > /opt/sun/test.txt')
    #os.system('touch /opt/sun/', hostname)
